...
(function (e) {
    ...
    e.jqPagination.defaultOptions = {current_page: 1, link_string: "", max_page: null, page_string: "Page {current_page}", paged: function () {
    }};
    e.fn.jqPagination = function () {
        var t = this, n = Array.prototype.slice.call(arguments), r = !1;
        if (typeof n[0] == "string") {
            e.each(t, function () {
                var t = e(this).data("jqPagination");
                r = t.callMethod(n[0], n[1], n[2])
            });
            return r
        }
        t.each(function () {
