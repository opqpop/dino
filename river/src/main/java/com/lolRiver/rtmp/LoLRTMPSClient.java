...
public class LoLRTMPSClient extends RTMPSClient {
    private static final Logger LOGGER = Logger.getLogger(LoLRTMPSClient.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOGGER.debug(client.getResult(id));
    ...
    public LoLRTMPSClient(String region, String clientVersion, String user, String pass) {
        ...
        if (region.equals("NA")) {
            ...
            LOGGER.error("Valid regions are: NA, EUW, EUN/EUNE, KR, BR, LAN, LAS, OCE, TR, PBE, SG/MY, TW, TH, PH, " +
                         "VN");
    ...
    private void getAuthToken() throws IOException {
        ...
        if (!result.containsKey("token")) {
            ...
            LOGGER.info("In login queue for " + region + ", #" + (id - cur) + " in line");
            ...
            while (id - cur > rate) {
                ...
                LOGGER.info("In login queue for " + region + ", #" + Math.max(1, id - cur) + " in line");
            }
