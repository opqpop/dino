...
import com.lolRiver.achimala.leaguelib.services.GameService;
import com.lolRiver.achimala.leaguelib.services.LeaguesService;
import com.lolRiver.achimala.leaguelib.services.PlayerStatsService;
import com.lolRiver.achimala.leaguelib.services.SummonerService;
import com.lolRiver.achimala.util.Callback;
import com.lolRiver.rtmp.TypedObject;
import org.apache.log4j.Logger;

public class LeagueConnection {
    private static final Logger LOGGER = Logger.getLogger(LeagueConnection.class.getName());
    ...
    public void invokeWithCallback(String service, String method, Object arguments, final Callback<TypedObject> callback) {
        try {
            LeagueAccount account = nextValidAccount();
            LOGGER.debug("Invoking: " + service + "on nextValidAcc: " + account);
            account.invokeWithCallback(service, method, arguments, callback);
