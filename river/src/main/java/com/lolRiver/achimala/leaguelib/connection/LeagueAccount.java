...
import com.lolRiver.rtmp.LoLRTMPSClient;
...
public class LeagueAccount {
    ...
    public void invokeWithCallback(String service, String method, Object arguments, final Callback<TypedObject> callback) {
        try {
            LOGGER.debug(_username + " performing " + method + " in " + service);
            _internalClient.invokeWithCallback(service, method, arguments, new com.lolRiver.rtmp.Callback() {
